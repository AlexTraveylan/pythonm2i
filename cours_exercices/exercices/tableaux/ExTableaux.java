...
public class ExTableaux {
    ...
    //suivantes : {{'B','A','Y'}{'R','A','O'}{'A','V','U'}{'V','A','P'}{'O',' ','I'}}
    //* 2. Passer tous les caractères du deuxième tableau en minuscules
    //* 3. Afficher les éléments en itérant par la première dimension, puis la deuxième
    
    private static void exosupp(){
    char[][] characters = {{'B','J','Y'},{'R','A','O'},{'A','V','U'},{'V','A','P'},{'O',' ','I'}};
